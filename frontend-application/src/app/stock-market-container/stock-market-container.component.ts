...
@Component({
  ...
  standalone: true,
  imports: [MatToolbarModule, MatMenuModule, MatIconModule, HttpClientModule],
...
export class StockMarketContainerComponent {
  ...
  ngOnInit(): void {
    ...
    // const socket = new WebSocket('wss://ws.finnhub.io?token=cnuu2o9r01qub9j02akgcnuu2o9r01qub9j02al0');
